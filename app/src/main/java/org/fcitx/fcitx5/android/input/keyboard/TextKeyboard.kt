    ...
    companion object {
        ...
        val SplitLayout: List<List<KeyDef>> = listOf(
            ...
            listOf(
                ...
                AlphabetKey("Z", "重", "'", percentWidth = 0.06f),
                AlphabetKey("X", "止", ":", percentWidth = 0.06f),
                AlphabetKey("C", "金", "\"", percentWidth = 0.06f),
                AlphabetKey("V", "女", "?", percentWidth = 0.06f),
                spacer(0.25f),
                AlphabetKey("B", "月", "!", percentWidth = 0.07f),
                AlphabetKey("N", "弓", "~", percentWidth = 0.07f),
                AlphabetKey("M", "一", "\\", percentWidth = 0.07f),
                BackspaceKey(),
            ),
            listOf(
