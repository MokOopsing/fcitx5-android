...
class TextKeyboard(
    ...
    companion object {
        ...
        val SplitLayout: List<List<KeyDef>> = listOf(
            ...
            listOf(
                AlphabetKey("A", "日", "@", percentWidth = 0.068f),
                AlphabetKey("S", "尸", "*", percentWidth = 0.068f),
                AlphabetKey("D", "木", "+", percentWidth = 0.068f),
                AlphabetKey("F", "火", "-", percentWidth = 0.068f),
                AlphabetKey("G", "土", "=", percentWidth = 0.068f),
                spacer(0.25f),
                AlphabetKey("G", "土", "=", percentWidth = 0.068f),
                AlphabetKey("H", "的", "/", percentWidth = 0.068f),
                AlphabetKey("J", "十", "#", percentWidth = 0.068f),
                AlphabetKey("K", "大", "(", percentWidth = 0.068f),
                AlphabetKey("L", "中", ")", percentWidth = 0.068f),
            ),
            listOf(
                CapsKey(percentWidth = 0.103f),
                AlphabetKey("Z", "重", "'", percentWidth = 0.068f),
                AlphabetKey("X", "止", ":", percentWidth = 0.068f),
                AlphabetKey("C", "金", "\"", percentWidth = 0.068f),
                AlphabetKey("V", "女", "?", percentWidth = 0.068f),
                spacer(0.25f),
                AlphabetKey("V", "女", "?", percentWidth = 0.068f),
                AlphabetKey("B", "月", "!", percentWidth = 0.068f),
                AlphabetKey("N", "弓", "~", percentWidth = 0.068f),
                AlphabetKey("M", "一", "\\", percentWidth = 0.068f),
                BackspaceKey(percentWidth = 0.103f),
            ),
            listOf(
                LayoutSwitchKey("?123", percentWidth = 0.105f),
                CommaKey(0.075f, Variant.Alternative),
                SpaceKey(0.64f),
                LanguageKey(0.075f),
                ReturnKey(0.105f),
            )
