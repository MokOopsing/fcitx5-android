...
abstract class BaseKeyboard(
    ...
    private val splitThresholdListener = ManagedPreference.OnChangeListener<Float> { _, _ ->
        rebuildKeyboardRows(shouldSplitByOrientation())
    }
    ...
    private fun shouldSplitByOrientation(): Boolean {
        return resources.configuration.orientation == Configuration.ORIENTATION_LANDSCAPE && isSplitAllowed()
    }
    ...
    private fun splitGapRatio(): Float {
        val percent = prefs.keyboard.splitKeyboardBlankRatio.getValue()
